...
const footerNavigation = {
  main: [
    { name: 'Certificates', href: 'https://packagingschool.com/certificates/' },
    { name: 'Courses', href: 'https://packagingschool.com/all_courses/' },
    {
      name: 'About',
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/packagingschool/',
      icon: (props) => (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/packagingschool/?hl=en',
      icon: (props) => (
        <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
          <path
            fillRule='evenodd'
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/PackagingSchool',
      icon: (props) => (
        <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
