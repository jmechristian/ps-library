    ...
    <div className='flex flex-col'>
      <div className='flex flex-col gap-6 py-3'>
        <div className='flex flex-col md:flex-row md:items-center gap-6 md:gap-8'>
          ...
          <div className='text-3xl md:text-4xl font-greycliff font-bold text-white/70 md:text-slate-900'>
            Who is this course for?
          </div>
        </div>
        <div className='text-xl font-greycliff text-white md:text-slate-900 leading-normal font-medium tracking-wide'>
