...
export default function Home() {
  return (
    <div className='bg-white'>
      <main className='mx-auto w-full max-w-7xl px-6 pt-6 pb-16 sm:pb-24 lg:px-8'>
        <div className='mx-auto mt-20 max-w-2xl text-center sm:mt-24'>
          <p className='text-base font-semibold leading-8 text-slate-600'>
            Something New is Coming.
          </p>
          <h1 className='mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl'>
            The Packaging School Library is current under renovation.
          </h1>
          <p className='mt-4 text-base leading-7 text-gray-600 sm:mt-6 sm:text-lg sm:leading-8'>
            Please use the navigation below to help guide you along campus.
          </p>
        </div>
        <div className='mx-auto mt-16 flow-root max-w-lg sm:mt-20'>
          ...
          >
            {links.map((link, linkIdx) => (
              <li
                key={linkIdx}
                className='relative flex items-center gap-x-6 py-6'
              >
